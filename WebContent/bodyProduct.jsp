					...
					<s:iterator value="productinfo">
						...
						<div class="container">
							...
							<s:if test="%{valid>0}">
								...
								<font color="#E40000">
								Hurry !!! This offer is valid only for <s:property value="valid"/> more days. 
								</font>
							</s:if>
							<s:if test="%{valid==0}">
								<font size="5" color="#76553B">
								...
								<font color="#E40000">
								This offer ends today. Hurry!!! 
								</font>
							</s:if>
						<hr>
						Seller: <a href="sellerRating?sellerId=<s:property value="sellerID" />"> <font color="black" size="4"><s:property value="sellerFName" /><s:property value="sellerLName" /> </font> </a>
						<br>
						</div>
						<hr>
